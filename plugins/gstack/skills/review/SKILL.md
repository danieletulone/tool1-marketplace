...
Find and read the review checklist. Search for `checklist.md` in the gstack plugin:

```bash
# Find checklist.md in the gstack plugin
for candidate in \
...
Then read the file at the found path.
