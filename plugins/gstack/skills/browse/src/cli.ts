...
export function resolveServerScript(
  ...
  // Legacy fallback — try to find server.ts relative to the plugin structure
  return path.resolve(env.HOME || '/tmp', '.claude/plugins/gstack/skills/browse/src/server.ts');
}
